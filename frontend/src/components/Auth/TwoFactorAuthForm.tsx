...
const TwoFactorAuthForm: React.FC<TwoFactorAuthFormProps> = ({ email = "Email@gmail.com" }) => {
    ...
    <Box sx={{ display: 'flex', minHeight: '100vh', bgcolor: '#fff' }}>
      ...
      <Box sx={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', px: 4 }}>
        <Box sx={{ width: '100%', maxWidth: 370 }}>
          ...
          <Typography sx={{ color: '#6b7280', fontWeight: 500, fontSize: 16, mb: 0.5, textAlign: 'center' }}>
            Enter Verification Code
          </Typography>
          <Typography sx={{ color: '#13b67a', fontWeight: 700, fontSize: 16, mb: 3, textAlign: 'center' }}>{email}</Typography>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', mb: 3 }}>
            <Typography sx={{ color: '#8a8a8a', fontSize: 14, fontWeight: 400, mr: 0.5 }}>Didn't receive code ?</Typography>
            <Link href="#" underline="none" sx={{ color: '#1a237e', fontWeight: 500, fontSize: 14, cursor: 'pointer', ml: 0.5 }}>
              Resend
            </Link>
          </Box>
          <Button
          ...
          <Box sx={{ textAlign: 'center', mt: 1 }}>
            <Link href="#" underline="none" sx={{ color: '#6b7280', fontWeight: 500, fontSize: 16, cursor: 'pointer' }}>
              Go back
            </Link>
          </Box>
        </Box>
