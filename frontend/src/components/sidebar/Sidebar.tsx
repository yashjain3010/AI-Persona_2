...
const Sidebar: React.FC<{
  ...
  const handleNewChat = () => {
    // You can pick the first persona, or random, or a special "new" persona
    const defaultPersona = mockPersonas[0];
    if (defaultPersona) {
    ...
    >
      ...
      >
        ...
        <ListItem
          ...
          onClick={() =>
            navigate(`/view-persona/${currentPersonaId || mockPersonas[0].id}`)
          }
        >
          <ListItemAvatar sx={{ minWidth: { xs: 40, sm: 32 } }}>
